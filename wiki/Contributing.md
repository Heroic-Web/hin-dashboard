...
Thank you for your interest in contributing to hin! This guide will help you get started.
...
Found a bug? [Create an issue](https://github.com/Heroic-Web/hin-dashboard/issues/new?template=bug_report.md)

### ✨ Suggest Features

Have an idea? [Start a discussion](https://github.com/Heroic-Web/hin-dashboard/discussions/new)
...
Help make hin available in more languages.
...
2. **Clone your fork:**
   ```bash
   git clone https://github.com/YOUR_USERNAME/hin.git
   cd hin
   ```

3. **Add upstream remote:**
   ```bash
   git remote add upstream https://github.com/Heroic-Web/hin-dashboard.git
   ```
...
- Check the [FAQ](FAQ)
- Ask in [GitHub Discussions](https://github.com/Heroic-Web/hin-dashboard/discussions)

---

<p align="center">
  <strong>Thank you for contributing to hin!</strong><br>
