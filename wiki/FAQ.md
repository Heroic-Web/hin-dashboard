...
Find quick answers to common questions about hin.
...
hin is a comprehensive, open-source affiliate management platform built with Next.js, TypeScript, and PostgreSQL. It provides everything you need to create, manage, and scale your affiliate marketing program.
...
Yes! hin is 100% free and open-source under the MIT License. You can use it commercially without any licensing fees. However, you'll need to pay for:
...
### How is hin different from other affiliate platforms?
...
Following our [Quick Start Guide](Quick-Start-Guide), you can have hin running in **5-10 minutes**.

### Do I need coding knowledge to use hin?
...
### Can I install hin on shared hosting?

hin requires Node.js and PostgreSQL, which most shared hosting doesn't support. We recommend:
- **Vercel** (easiest, free tier available)
- **DigitalOcean** (affordable, $5/month)
- **AWS** (scalable, pay-as-you-go)
- **Docker** (self-hosted)

### What database does hin use?

hin uses **PostgreSQL** via Prisma ORM. Support for MySQL/MariaDB is planned for future releases.
...
hin tracks referrals in two ways:
...
### What technologies does hin use?
...
### Can I use hin with my existing application?

Yes! hin provides a REST API that you can integrate with any application. Use webhooks (coming v1.1.0) for real-time updates.

### Does hin have an API?

Yes! hin has a comprehensive REST API with 31 endpoints. See our [API Overview](API-Overview) for details.

### Is hin mobile-friendly?

Yes, hin is fully responsive and works on mobile devices. Native mobile apps are planned for v1.5.0.

### Can I use hin offline?

No, hin requires an internet connection. It's a web application that needs server communication.
...
3. Ensure database exists: `createdb hin`
...
### Is hin really free forever?

Yes! hin is MIT licensed, which means:
- ✅ Free to use
- ✅ Free to modify
...
- ✅ Use privately
- ✅ Sell products built with hin

You must:
- ⚠️ Include the original license
- ⚠️ Credit the hin Team
...
No! hin doesn't charge any fees. However:
...
### Can I remove "Powered by hin"?

Yes, the MIT License allows you to remove any branding. However, we'd appreciate attribution!

### Is there a paid version?

Currently no. hin is 100% open source. We may offer paid support or custom development in the future.
...
Yes, hin uses standard React components. You can replace them with your own components.
...
### Does hin integrate with Shopify?
...
- **[GitHub Issues](https://github.com/Heroic-Web/hin-dashboard/issues)** - Bug reports
- **[GitHub Discussions](https://github.com/Heroic-Web/hin-dashboard/discussions)** - Questions and ideas
- **Email** - hello@hin.com

### How do I report a bug?

1. Check [existing issues](https://github.com/Heroic-Web/hin-dashboard/issues)
2. Create a [new issue](https://github.com/Heroic-Web/hin-dashboard/issues/new)
3. Include:
   - hin version
   - Steps to reproduce
...
2. Search [existing requests](https://github.com/Heroic-Web/hin-dashboard/discussions)
3. Create a [new discussion](https://github.com/Heroic-Web/hin-dashboard/discussions/new)
4. Explain the feature and use case

### Can I hire someone to customize hin?

Yes! You can:
- Hire freelance developers
- Contact us for custom development: hello@hin.com
...
Yes, hin follows security best practices:
- JWT authentication
...
### Is hin GDPR compliant?

hin provides the tools, but GDPR compliance depends on how you use it. You're responsible for:
- Privacy policy
- Cookie consent
...
### Does hin track users?

hin tracks affiliate activity (referrals, commissions) for program management. No third-party tracking by default.
...
### How many affiliates can hin handle?
...
- **Ask in Discussions** - [GitHub Discussions](https://github.com/Heroic-Web/hin-dashboard/discussions)
- **Email us** - hello@hin.com

---

<p align="center">
  <strong>Didn't find your answer?</strong><br>
  Ask in <a href="https://github.com/Heroic-Web/hin-dashboard/discussions">GitHub Discussions</a>
</p>
