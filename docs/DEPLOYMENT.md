# Deploying hin to Vercel

**Author: hin Team**

Complete guide for deploying hin to Vercel with PostgreSQL database.
...
git init
git add .
git commit -m "Initial commit - hin by hin Team"
git branch -M main
git remote add origin https://github.com/yourusername/hin.git
...
EMAIL_FROM=hin <noreply@hin.com>
...
2. Add your domain: `hin.com`
3. Add subdomain: `app.hin.com`
