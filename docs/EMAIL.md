# Email Configuration Guide for hin

## Overview

hin uses [Resend](https://resend.com) for sending transactional emails. Resend is a modern email API designed for developers with:
...
2. Give it a name (e.g., "hin Production")
...
2. Click **"Add Domain"**
3. Enter your domain (e.g., `hin.com`)
...
hin includes the following email templates:
...
### hin Support
For issues specific to hin's email implementation:
